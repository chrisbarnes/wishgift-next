...
describe('LargeHero', () => {
  ...
  it('renders description when provided', () => {
    render(<LargeHero {...mockProps} />);
    expect(screen.getByText('Share your wish list with friends and family')).toBeInTheDocument();
  });

  it('does not render description when not provided', () => {
    render(<LargeHero {...mockProps} description={null} />);
  ...
  it('applies correct container styles', () => {
    ...
    expect(heroDiv).toHaveClass('relative', 'flex', 'flex-col', 'justify-center', 'items-center');
  });
});
